  ...
  <div class="form-group">
    ...
    <div class="form-group">
      <label for="inputdefault">이름</label>
        <input class="form-control" id="board_id" type="hidden" name = 'board_id' value="${user.user_id}" >
        <input class="form-control" id="board_name" type="text" name = 'board_name' value="${user.user_name}" readonly="readonly">
    </div>
