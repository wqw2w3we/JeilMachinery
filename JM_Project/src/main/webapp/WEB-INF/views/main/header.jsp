...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <li><a href="../board/intro">회사 소개</a></li>
      <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#">제품 정보<span class="caret"></span></a>
        <ul class="dropdown-menu" style="background-color: black;">
          <li><a href="../machine/hsm1">소형 불박기계</a></li>
          <li><a href="../machine/hsm2">꺽기식 금박기계</a></li>
          <li><a href="../machine/hsm3">반자동 탁상용 카렌더</a></li>
          <li><a href="../machine/hsm4">공압식 금박기계</a></li>
          <li><a href="../machine/hsm5">스프링식 금박기계</a></li>
        </ul>
      </li>
